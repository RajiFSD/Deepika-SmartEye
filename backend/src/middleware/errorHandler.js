...
//    // In FireDetectionPage.jsx - Update loadAlerts function
...
//       tenant_id: tenantId,  
//       branch_id: branchId,
//       status: 'active' // Only get active alerts for current display
//     });
...
//         camera_name: alert.camera?.camera_name || selectedCamera?.camera_name || 'Unknown Camera',
...
//         // ✅ Check if this is a NEW alert (different ID or first alert)
//         const isNewAlert = !currentAlert || currentAlert.id !== activeAlert.id;
        
//         setCurrentAlert(activeAlert);
        
//         // ✅ Play sound if settings enabled AND it's a new alert
//         if (settings.alertSound && isNewAlert) {
//           console.log('🔊 Playing alert sound for fire detection!');
//           playAlertSound();
//         }
//       } else if (!activeAlert) {
...
//     console.log('Starting detection with settingsI-----:', )
//     if (!selectedCamera) {
...
//     try {
//       console.log("starting detection for camera:", selectedCamera);
//       const cameraId = selectedCamera.camera_id || selectedCamera.id;
//       console.log('Starting detection with settings:',cameraId);
...
//     // ✅ If error is "No active detection", just update UI state
...
// useEffect(() => {
//   // Play sound when currentAlert changes to a new active alert
//   if (currentAlert && !currentAlert.resolved && settings.alertSound && isDetecting) {
//     console.log('🔊 FIRE ALERT! Playing alarm sound...');
//     playAlertSound();
//   }
// }, [currentAlert?.id]); // Only trigger when alert ID changes
